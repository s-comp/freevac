...
gulp.task('js', function () {
	return gulp.src([
		...
		'libs/datetimepicker/js/bootstrap.min.js',
		'libs/datetimepicker/js/bootstrap-datetimepicker.js',
...
//Watch
gulp.task('watch', ['clean', 'styles', 'media', 'pug', 'js', 'browser-sync'], function () {

	gulp.watch(syntax + '/**/*.' + syntax + '', ['styles']);
	gulp.watch('../css/*.css', ['media'], browserSync.reload);
